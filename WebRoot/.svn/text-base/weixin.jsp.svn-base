<%@page import="com.qq.weixin.mp.aes.Signature"%>
...
*/    
<% String time = Signature.getTimeStamp();
String non=Signature.getRandomStr();
String sig = Signature.getSignature("http://wx.filmgear-bj.com/Kacaz/weixin.jsp", time, non);%>
wx.config({    
debug: true,
appId: 'wx26fff0b8e6eef099', 
timestamp: '<%=time %>',
nonceStr: '<%=non%>',    
signature: '<%= sig %>',    
jsApiList: [    
...
<script src="js/weixin_sdk.js"> </script>    
</html>